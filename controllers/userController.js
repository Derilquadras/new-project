...
exports.Register = async (req, res) => {
  ...
  if (userExist) return res.status(400).json({status:"fail",message:"Email or password is wrong"});
...
exports.Login = async (req, res) => {
  ...
  if (!validPass) return res.status(400).json({status:"fail",message:"Email or password is wrong"});
